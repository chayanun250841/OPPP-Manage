...
**⚠️ ถ้าฐานข้อมูลมีข้อมูลเก่าค้างอยู่** ให้ย้อนกลับ (rollback) ทุก batch เดิมแล้วอัปโหลดใหม่ เพราะแถวเก่ามีทั้งรายการที่ไม่มีเงิน PP/FS ปนอยู่ และ `grand_total` เป็น 0
